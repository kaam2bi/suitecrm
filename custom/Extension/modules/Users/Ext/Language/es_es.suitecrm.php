...
$mod_strings = array_merge($mod_strings,
    array(
        'LBL_SUITE_SUPERCHARGED' => "Con los añadidos de SuiteCRM",
        'LBL_SUITE_POWERED_BY' => "CRM basado en SugarCRM",
        'LBL_SUITE_TOP' => "Volver arriba",
        'LBL_SUITE_PRINT' => "Imprimir página",
        ...
        'LBL_QUICK_ACCOUNT' => 'Crear Empresa',
